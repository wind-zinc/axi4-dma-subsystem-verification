...
regression_tests=(
  ...
  "dma_subsys_ch1_to_ch0_test"
  "dma_subsys_crossbar_path_matrix_test"
  "dma_subsys_transfer_length_boundary_test"
  "dma_subsys_register_access_policy_test"
  "dma_subsys_axi_burst_shape_test"
  "dma_subsys_route_contention_test"
  "dma_subsys_completion_order_reverse_test"
  "dma_subsys_irq_mask_multi_pending_test"
  "dma_subsys_descriptor_error_test"
  "dma_subsys_abort_timing_test"
  "dma_subsys_reset_recovery_test"
  "dma_subsys_memory_response_error_test"
  "dma_subsys_status_fault_injection_test"
  "dma_subsys_axil_protocol_timing_test"
  "dma_subsys_irq_status_separation_test"
  "dma_subsys_status_fault_expansion_test"
  "dma_subsys_abort_phase_matrix_test"
  "dma_subsys_toggle_value_sweep_test"
)
