    ...
    task run_phase(uvm_phase phase);
        ...
        forever begin
            ...
            if (vif.mon_cb.awvalid && vif.mon_cb.awready) begin
                ...
                awprot_q.push_back(vif.mon_cb.awprot);
            end
            ...
            if (vif.mon_cb.bvalid && vif.mon_cb.bready) begin
                if (awaddr_q.size() == 0 || awprot_q.size() == 0 ||
                        wdata_q.size() == 0) begin
                    `uvm_error("AXIL_MON",
            ...
            if (vif.mon_cb.arvalid && vif.mon_cb.arready) begin
                ...
                arprot_q.push_back(vif.mon_cb.arprot);
            end

            if (vif.mon_cb.rvalid && vif.mon_cb.rready) begin
                if (araddr_q.size() == 0 || arprot_q.size() == 0) begin
                    `uvm_error("AXIL_MON",
